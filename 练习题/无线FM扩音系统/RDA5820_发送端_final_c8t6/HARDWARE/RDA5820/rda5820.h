...
void RDA5820_TxPAG_Set(u8 gain);//设置TX发送功率 gain:0~63
void RDA5820_TxPGA_Set(u8 gain);//设置TX 输入信号增益 gain:0~7
...
u8 RDA5820_FMSeek(void);
u8 RDA5820_Seek_Station(u16 FreqStart,u16 SEEKTH);  //收音的搜台

u16 RDA5820_Seek_Channel(void); //自动搜索空闲频段并设置
#endif
